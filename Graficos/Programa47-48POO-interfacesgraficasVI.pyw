...
BotonDividir=Button(miframe, text="/", justify="center", width=3)
...
BotonMultiplicar=Button(miframe, text="X", justify="center", width=3)
...
BotonRestar=Button(miframe, text="-", justify="center", width=3)
...
BotonComa=Button(miframe, text=".", justify="center", width=3)
BotonComa.grid(row=5, column=2)

BotonIgual=Button(miframe, text="=", justify="center", width=3)
BotonIgual.grid(row=5, column=3)

BotonSumar=Button(miframe, text="+", justify="center", width=3)
